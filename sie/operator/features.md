...
| GSM Mechanism execution foundations | Execute governed Mechanisms in the same sandboxed, reproducible rule runtime (basic runtime exists today) | v1.1 |
| GSM Mechanism execution technos integrations | Extend Mechanism execution to further target technologies, ongoing after the foundations land | v1.x |
