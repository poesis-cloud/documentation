...
git clone https://github.com/poesis-cloud/safe-agentic-organization \
  ~/.vscode/agent-plugins/github.com/poesis-cloud/safe-agentic-organization
```
...
```bash
cd ~/.vscode/agent-plugins/github.com/poesis-cloud/safe-agentic-organization
git fetch --tags
git checkout v0.1.0
```
...
- Ensure the clone is at the exact path `~/.vscode/agent-plugins/github.com/poesis-cloud/safe-agentic-organization`.
...
- Verify `plugins/poesis-safe-agentic-organization/agents/` contains `*.agent.md` files.

**Skills fail to load (agent says "skill not found")**

- Confirm that the orchestration-core skill is present:
  `ls ~/.vscode/agent-plugins/github.com/poesis-cloud/safe-agentic-organization/plugins/poesis-safe-agentic-organization/skills/`

---

## What's next

- Read [CONTRIBUTING.md](https://github.com/poesis-cloud/safe-agentic-organization/blob/main/CONTRIBUTING.md) to understand how to contribute improvements.
- Check [GitHub Releases](https://github.com/poesis-cloud/safe-agentic-organization/releases) for version history.
- File issues at [github.com/poesis-cloud/safe-agentic-organization/issues](https://github.com/poesis-cloud/safe-agentic-organization/issues).
