...
# SAFe Agentic Organization Features
{: .no_toc }

Capability catalogue for the SAFe Agentic Organization.
...
- **Foundation** — implemented today (installable framework application).
