...
- **[SAF SIE Bridge]({% link saf/saf-sie-bridge/index.md %})** — the client sourcer turning harness-governed execution history into GSM contributions on the Definition Blackboard Manager. *Documentation in construction.*
