...
This specification standardizes the *model and its interchange*. It is intentionally independent of any storage technology, programming language, or deployment topology. The companion **[Manifesto]({% link gsm/manifesto.md %})** states the design intent and principles in non-normative form.
...
- [Manifesto]({% link gsm/manifesto.md %}) — The GSM Manifesto (design intent and principles).
- [SIE]({% link sie-definition.md %}) — Reference implementation overview.
