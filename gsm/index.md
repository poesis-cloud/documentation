...
The GSM standard is documented as a CNCF-style document set:
...
- **[Specification]({% link gsm/specification.md %})** — the normative standard: the eight primitives, the DNA governance grammar, the Archetype type system, the Ascription lifecycle, the expression-language profiles, the canonical JSON interchange, and conformance.
