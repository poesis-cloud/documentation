...
> See also: [Cloud-Native Use Cases]({% link gsm/cloud-native-use-cases.md %}), the [Specification]({% link gsm/specification.md %}) (normative model), and the [Primer]({% link gsm/primer.md %}) (intuition).
