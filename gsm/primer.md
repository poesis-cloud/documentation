...
**Status:** Non-normative companion to the [Specification]({% link gsm/specification.md %})
{: .fs-5 .fw-300 }

This primer builds intuition for the Generative System Model. It is **non-normative**: nothing here defines conformance. For the vision and principles, read the **[Manifesto]({% link gsm/manifesto.md %})**; for the binding rules, read the **[Specification]({% link gsm/specification.md %})**.
...
7. **§16** — conformance (then the [Conformance]({% link gsm/conformance.md %}) catalog).
