...
- **CNCF Slack and public calls.** Share the [Specification]({% link gsm/specification.md %}) and [Cloud-Native Use Cases]({% link gsm/cloud-native-use-cases.md %}); gather implementer interest.
...
| Artifact | Where |
|---|---|
| Normative specification | [Specification]({% link gsm/specification.md %}) |
| Conformance catalog (stable IDs) | [Conformance]({% link gsm/conformance.md %}) |
| Non-normative onboarding | [Primer]({% link gsm/primer.md %}) |
| Cloud-native relevance | [Cloud-Native Use Cases]({% link gsm/cloud-native-use-cases.md %}) |
| Proposed governance | [Charter]({% link gsm/charter.md %}) |
| Draft application | [CNCF Sandbox Proposal]({% link gsm/cncf-sandbox-proposal.md %}) |
