...
**Status:** Non-normative. The deeper *why* beneath the [Manifesto]({% link gsm/manifesto.md %}) (vision) and the [Specification]({% link gsm/specification.md %}) (rules).
{: .fs-5 .fw-300 }
...
> Continue: the [Specification]({% link gsm/specification.md %}) (normative model and §15 eliminations), the [Primer]({% link gsm/primer.md %}) (worked intuition), and the [Manifesto]({% link gsm/manifesto.md %}) (vision and principles).
