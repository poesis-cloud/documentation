...
- **Current repository license:** **BUSL-1.1** — source-available, not Open Source. It is a pre-publication holding license, replaced by the posture below when the specification is published.
